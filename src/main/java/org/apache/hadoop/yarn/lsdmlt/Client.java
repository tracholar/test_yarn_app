package org.apache.hadoop.yarn.lsdmlt;
...
public class Client {
    ...
    private void run(String[] args) throws Exception {
        ...
        String cmd = Environment.JAVA_HOME.$$() + "/bin/java"
                + " -Xmx900m"
                + " org.apache.hadoop.yarn.lsdmlt.ApplicationMaster"
        ...
        appContext.setApplicationName(jobName + ":LSDMLT");
        ...
        while (appState != YarnApplicationState.FINISHED
            ...
            if((System.currentTimeMillis() - startTime) % 60000 == 0) { // 1 min report state
